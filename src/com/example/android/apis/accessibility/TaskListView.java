...
final class TaskAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
	        ...
	        viewHolder.label = (TextView)(convertView.findViewById(R.id.tasklist_label));
	        viewHolder.checkbox = (CheckBox) convertView.findViewById(R.id.tasklist_finished);
            convertView.setTag(viewHolder);
        } else {
        	viewHolder = (ViewHolder) convertView.getTag();
        }

        viewHolder.checkbox.setChecked(mCheckboxes[position]);
        viewHolder.label.setText(mLabels[position]);

        String contentDescription = new StringBuilder()
                .append(mContext.getString(R.string.task_name))
                .append(' ')
                .append(mLabels[position]).toString();
        viewHolder.label.setContentDescription(contentDescription);
    ...
    class ViewHolder {
//    	@InjectView(id = R.id.tasklist_finished)
    	public CheckBox checkbox;
//    	@InjectView(id = R.id.tasklist_label)
